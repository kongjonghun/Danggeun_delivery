...
public class Frag_My extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.my, container, false); // my 화면 연결

        profile_image = view.findViewById(R.id.profile_image);
        username = view.findViewById(R.id.username);
        btn_logout = view.findViewById(R.id.btn_logout);
        my_gps = view.findViewById(R.id.my_gps); // 내 위치 확인하기 버튼

        my_gps.setOnClickListener(new View.OnClickListener()
        {
            @Override
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(user.getImageURL().equals("default")){
                    ...
                    Glide.with(Frag_My.this).load(user.getImageURL()).into(profile_image);
                }
            }
